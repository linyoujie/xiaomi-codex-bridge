...
final class StatusModel {
    ...
    final long startedAtMs, hostTimeMs, hostElapsedMs, completedAtMs, quota7dResetsAtMs;
    ...
    StatusModel(String state, String title, String phase, String taskTitles, long startedAtMs, int activeCount,
                int quota5h, int quota7d, long quota7dResetsAtMs, long hostTimeMs, long hostElapsedMs,
        ...
        this.activeCount=activeCount; this.quota5h=quota5h; this.quota7d=quota7d;this.quota7dResetsAtMs=quota7dResetsAtMs;
    ...
    static StatusModel load(Context c) {
        ...
        return new StatusModel(p.getString("state","idle"),p.getString("title","Codex"),
            ...
            p.getInt("quota_5h_percent",-1),p.getInt("quota_7d_percent",-1),p.getLong("quota_7d_resets_at_ms",0),
    ...
    StatusModel effective(){
        ...
        if(fresh!=connected)return new StatusModel(state,title,phase,taskTitles,startedAtMs,activeCount,quota5h,quota7d,quota7dResetsAtMs,
